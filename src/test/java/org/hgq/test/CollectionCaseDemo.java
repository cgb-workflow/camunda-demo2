...
public class CollectionCaseDemo {
...
//            collectionCase.setEmpName("催收员" +i);
    ...
    public void createDeployment() {
        ...
        Deployment deploy = deploymentBuilder
                .name("案件分配流程")
                .addClasspathResource("bpmn/case_allocation.bpmn").deploy();
    ...
    public void queryProcessDefinitionId() {
        ...
        List<ProcessDefinition> list = processDefinitionQuery.deploymentId("d8b90932-00ad-11ec-a638-ace2d36d35ee").list();
