...
public class CollectionDerateDemo {
    ...
    public void deploy() {
        Deployment deployment = repositoryService
                .createDeployment()
                .name("催收减免申请1")
                .addClasspathResource("collection_derate_1.bpmn")
                .deploy();
    ...
    public void definitionByProcessDefinitionKey() {
        ...
        String processDefinitionKey = "collection_derate_1";
        ProcessDefinitionQuery processDefinitionQuery = repositoryService.createProcessDefinitionQuery();
    ...
    public void startProcess() {
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey(processDefinitionKey, collection_derate_id.toString());
