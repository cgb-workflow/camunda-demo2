...
public class CollectionLogSqlProvider {
    ...
    public String insertSelective(CollectionLog record) {
        ...
        if (record.getCollectionCaseId() != null) {
            sql.VALUES("collection_case_id", "#{collectionCaseId,jdbcType=BIGINT}");
        }
        ...
        if (record.getPromiseRepayTime() != null) {
            sql.VALUES("promise_repay_time", "#{promiseRepayTime,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getCollectionCaseId() != null) {
            sql.SET("collection_case_id = #{record.collectionCaseId,jdbcType=BIGINT}");
        }
        ...
        if (record.getPromiseRepayTime() != null) {
            sql.SET("promise_repay_time = #{record.promiseRepayTime,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByPrimaryKeySelective(CollectionLog record) {
        ...
        if (record.getCollectionCaseId() != null) {
            sql.SET("collection_case_id = #{collectionCaseId,jdbcType=BIGINT}");
        }
        ...
        if (record.getPromiseRepayTime() != null) {
            sql.SET("promise_repay_time = #{promiseRepayTime,jdbcType=TIMESTAMP}");
        }
