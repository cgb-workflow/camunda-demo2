...
public interface CollectionLogMapper {
    ...
    @Insert({
        ...
        "collection_result, promise_repay_date, ",
        ...
        "deleted, create_time, ",
        "update_time)",
        "values (#{id,jdbcType=BIGINT}, #{collectionCaseId,jdbcType=VARCHAR}, ",
        "#{collectionObject,jdbcType=TINYINT}, #{callWay,jdbcType=TINYINT}, ",
        "#{callPhone,jdbcType=VARCHAR}, #{callResult,jdbcType=TINYINT}, ",
        "#{collectionResult,jdbcType=TINYINT}, #{promiseRepayDate,jdbcType=TIMESTAMP}, ",
    ...
    @Results({
        ...
        @Result(column="collection_case_id", property="collectionCaseId", jdbcType=JdbcType.VARCHAR),
        ...
        @Result(column="promise_repay_date", property="promiseRepayDate", jdbcType=JdbcType.TIMESTAMP),
    ...
    @Select({
        ...
        "collection_result, promise_repay_date, promise_repay_amount, call_time, call_duration, ",
        "call_recording, emp_no, emp_NAME, remark, version, deleted, create_time, update_time",
        "from collection_log",
        "where id = #{id,jdbcType=BIGINT}"
    })
    @Results({
    ...
    @Update({
        ...
        "set collection_case_id = #{collectionCaseId,jdbcType=VARCHAR},",
